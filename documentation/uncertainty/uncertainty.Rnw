...
ggplot(data.frame(x = seq(cauchy$parameters$location - 10 * cauchy$parameters$scale, 
    ...
    scale_colour_manual("", values = c("blue", "purple", "orange", "gold", "steelblue"), 
                        breaks = c("Cauchy", "Normal", "Truncated-Normal", "Exponential", "Log-Normal")) +  
...
constraint = function(x){
    ## Productin + Import - Export - Food - Loss = 0
